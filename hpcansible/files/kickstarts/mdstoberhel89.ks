# Georgios Magklaras - Steelcyber.com Lustre MDS server -- RHEL8.9 version with lustre 2.15.4
...
dnf -y install http://192.168.122.33/lustre/2.15.4/el8.9/server/e2fsprogs-1.47.0-wc6.el8.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/e2fsprogs-devel-1.47.0-wc6.el8.x86_64.rpm  http://192.168.122.33/lustre/2.15.4/el8.9/server/e2fsprogs-libs-1.47.0-wc6.el8.x86_64.rpm  http://192.168.122.33/lustre/2.15.4/el8.9/server/libcom_err-1.47.0-wc6.el8.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/libcom_err-devel-1.47.0-wc6.el8.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/libss-1.47.0-wc6.el8.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/libss-devel-1.47.0-wc6.el8.x86_64.rpm


#Install the patched Lustre kernel
dnf -y install http://192.168.122.33/lustre/2.15.4/el8.9/server/kernel-core-4.18.0-513.9.1.el8_lustre.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/kernel-4.18.0-513.9.1.el8_lustre.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/kernel-devel-4.18.0-513.9.1.el8_lustre.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/kernel-headers-4.18.0-513.9.1.el8_lustre.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/kernel-modules-4.18.0-513.9.1.el8_lustre.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/kernel-modules-extra-4.18.0-513.9.1.el8_lustre.x86_64.rpm http://192.168.122.33/lustre/2.15.4/el8.9/server/kernel-modules-internal-4.18.0-513.9.1.el8_lustre.x86_64.rpm
...
cobbler-register -s 192.168.14.101 -f $( cat /etc/hostname ) --profile=mdsrhel89

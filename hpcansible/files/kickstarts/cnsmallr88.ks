# Georgios Magklaras - Steelcyber.com compute node small -- RHEL8.8 version with lustre 2.15.3
# Assumes a VM with at least 30 Gigs of disk storage 
...
case "\${#avail_devices[*]}" in
  ...
  1)
     ...
     echo "part pv.01 --fstype=\"lvmpv\" --ondrive=\${os_device} --size 40000 --grow" >> /tmp/partition-scheme.cfg
     ...
     echo "logvol /  --fstype="ext4" --grow --maxsize=15000 --size=8192 --name=lv_root --vgname=vg00" >> /tmp/partition-scheme.cfg
...
echo "-------------------------------------------------------------------"
echo "# THIS IS THE STEELCYBER LUSTRE SMALL (30 Gig) COMPUTE KICKSTART CONFIGURATION SCRIPT#"
echo "-------------------------------------------------------------------"
read -p "Please set the hostname for this OSS server (cn1, cn2): " OSS
...
echo "ssh-rsa  georgios@cn1" >> /root/.ssh/authorized_keys
...
mkdir -p /lustre/storeA

cat <<EOF >>/etc/fstab
192.168.14.194:/exports/home	/home		nfs	_netdev	0 0
192.168.14.194:/exports/modules	/modules	nfs	_netdev 0 0
192.168.14.121@tcp:/DIAS  /lustre/storeA lustre _netdev,rw,noauto,localflock,lazystatfs 0 0
EOF
...
#Necessary application packages and libraries 
dnf install -y htop redhat-lsb-core compat-hwloc1 git environment-modules openssl-devel libuuid-devel libseccomp-devel blas-devel lapack-devel cmake cmake3 boost-devel libxcb-devel libstdc++.x86_64 libstdc++-devel.x86_64 libstdc++-static.x86_64 gcc gcc-c++ freetype-devel libpng-devel libtiff-devel libjpeg-turbo-devel fribidi-devel libssh2 ncftp compat-hwloc1 ImageMagick readline-devel xorg-x11-server-devel libX11-devel libXt-devel xz-devel openblas-devel gdal-devel pkgconf-pkg-config proj-devel sqlite-devel geos-devel gsl moreutils ncdu gdal-libs gdal-devel libsysfs-devel libsysfs libffi-devel enscript gnuplot evince cairo cairo-devel s3cmd meld tcsh tk
...
cobbler-register -s 192.168.14.101 -f $( cat /etc/hostname ) --profile=computesmallr88
